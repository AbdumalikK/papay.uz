      ...
      <table class="table table-striped table-hover table-sortable data-table">
        <thead>
          <tr>
            ...
            <th data-sort="phone"><?php echo language::translate('title_phone', 'phone'); ?></th>
        ...
        <tbody>
          ...
          <tr class="<?php echo empty($customer['status']) ? 'semi-transparent' : null; ?>">
            ...
            <td><a href="<?php echo document::href_link('', array('doc' => 'edit_customer', 'customer_id' => $customer['id']), true); ?>"><?php echo $customer['phone']; ?></a></td>
