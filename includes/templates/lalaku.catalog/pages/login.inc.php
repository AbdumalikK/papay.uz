      ...
      <section id="box-login" class="box" style="">
        ...
        <?php echo functions::form_draw_form_begin('login_form', 'post', document::ilink('login'), false, 'style="max-width: 320px;"'); ?>
          ...
          <div class="form-group">
            <?php echo functions::form_draw_email_field('email', true, 'placeholder="ID raqamingiz"'); ?>
          </div>
          ...
          <div class="checkbox">
            <label><?php echo functions::form_draw_checkbox('remember_me', '1', true, 'checked'); ?> <?php echo language::translate('title_remember_me', 'Remember Me'); ?></label>
          </div>
