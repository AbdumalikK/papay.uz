<?php
  ...
  function form_draw_captcha_field($name, $id, $parameters='') {
    ...
    $output = '<div class="input-group">' . PHP_EOL
            ...
            . '  ' . form_draw_text_field('captcha', '', $parameters . ' placeholder="< Kodni kiriting" style="font-size: 24px; padding: 0; text-align: center;"') . PHP_EOL
            . '</div>';
  ...
  function form_draw_email_field($name, $value=true, $parameters='') {
    ...
    return '<div class="input-group">' . PHP_EOL
         . '  <span class="input-group-addon">'. functions::draw_fonticon('fa-address-card-o') .'</span>' . PHP_EOL
  ...
  function form_draw_function($function, $name, $input=true, $parameters='') {
    ...
    switch ($matches[1]) {
      ...
      case 'username':
        return functions::form_draw_username_field($name, $input, $parameters);
